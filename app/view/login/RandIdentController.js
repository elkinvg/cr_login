Ext.define('Login.view.login.RandIdentController', {
    extend: 'Ext.app.ViewController',

    alias: 'controller.randidentcheck',
    
    onCheckClick: function () {
        var randidentForm = this.lookupReference('randidentform');
        var uname = localStorage.getItem("login");
        
        var rand_ident = randidentForm.getForm().findField('rand_ident').value;
        var inpRI = rand_ident + uname;
        var snd_rand_ident = md5(inpRI);
        ...
        Ext.Ajax.request({
            ...
            params: {
                username: uname,
                rand_ident: snd_rand_ident
            },
            success: function (response, opts) {
                console.log("success rand_ident");
                localStorage.setItem("rand_ident",rand_ident);
            },
            failure: function (response, opts) {
                console.log("failure rand_ident");
            },
